...
import type { PlayerScoreEntry } from '../api/types'
...
const helper = createColumnHelper<typeof playerTableFeatures, PlayerScoreEntry>()
...
const columns = helper.columns([
  ...
  helper.accessor('next_gw_score', {
    header: 'Next GW score',
    sortFn: 'basic',
    cell: (info) => info.getValue().toFixed(1),
  }),
])

const EMPTY_DATA: PlayerScoreEntry[] = []

const ScoresTable = ({ players }: { players: PlayerScoreEntry[] }) => {
